<%@ Page Language="C#"  MasterPageFile="~/ControlPisoLamosa.Master" Title="Control de piso - Manejo de texto de etiqueta" AutoEventWireup="true" 
CodeBehind="ManejoEtiqueta.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Administracion.ManejoEtiqueta" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Manejo de texto de etiqueta" ></asp:Label><br/>
                </td> 
            </tr>
                                    ...
                                    <td>
                                        ...
                                        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" EnableAppStyling="False" > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                        <igtbl:UltraGridColumn Width="90px" BaseColumnName="Etiqueta" DataType="System.Int32" IsBound="True" Key="id" Hidden="False">
                                                            <Header Caption="Etiqueta"></Header>
                                                        ...
                                                        <table style="font-family: Arial; text-align: center">
                                                            <tr>
                                                                ...
                                                                <td class ="textos_01">
                                                                    ...
                                                                    <input ID="Text1"  style="width: 150px;" CssClass= "hidden" columnkey="IdEtiqueta" runat="server" visible="False" />
                                                                    <input ID="Text2" style="width: 150px;" columnkey="IdEtiqueta" runat="server" readonly="readonly" class ="mayus" />
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class ="textos_01">
                                                                    <input type="hidden" id="Hidden4" columnkey="descripcion" />
                                                                    <input id="Text4" columnkey="descripcion" style="width: 150px; height: 50px" type="text" class ="mayus">
                                                                </td>
                                                            </tr>
