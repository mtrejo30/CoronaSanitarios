<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
    CodeBehind="Calidad.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Administracion.Calidad" Title="Control de piso - Calidad" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "6"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Calidad" ></asp:Label><br/>
                </td> 
            </tr>
                                        ...
                                        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" EnableAppStyling="False" 
                                         OnPageIndexChanged = "cambio_pagina"  > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="CodCalidad" IsBound="True" Key="CodCalidad" >
                                                            <Header Caption="CodCalidad"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="ClaveCalidad" IsBound="True" Key="ClaveCalidad" CellMultiline="Yes">
                                                            <Header Caption="Clave calidad">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="DesCalidad" IsBound="True" Key="DesCalidad" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Hidden="true" Width="150px" BaseColumnName="FechaRegistro" IsBound="True" Key="FechaRegistro" CellMultiline="Yes">
                                                         ...
                                                         <igtbl:UltraGridColumn Width="150px" BaseColumnName="Activo" IsBound="True" Key="Activo"  Type="CheckBox" CellMultiline="no" AllowUpdate="No">
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Calidad" style="width: 200px;" type="text" runat="server"  />  
            ...
            <tr>
                ...
                <td >
                    <igtblexp:UltraWebGridExcelExporter ID="ExpCalidad" WorksheetName="Calidad" DownloadName="ReporteCalidad.XLS" runat='server'>
