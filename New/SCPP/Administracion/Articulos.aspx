<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
    CodeBehind="Articulos.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Administracion.Articulos" Title="Control de piso - Articulos" %>
    ...
    <div> 
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
               <td style="width:10px; background-color:#eee;"></td>
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Modelos"></asp:Label><br/>
                </td> 
            </tr>
                                    ...
                                    <td>
                                        ...
                                        OnPageIndexChanged = "cambio_pagina" > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="CodMolde"  IsBound="True" Key="CodMolde" >
                                                            <Header Caption="Clave única"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="ClaveMolde" IsBound="True" Key="ClaveMolde" CellMultiline="Yes">
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Articulos" style="width: 200px;" type="text" runat="server"  />  
            ...
            <tr>
                ...
                <td>
                    <igtblexp:UltraWebGridExcelExporter ID="ExpArticulos" WorksheetName="Articulo" DownloadName="ReporteArticulo.XLS" runat='server'>
