<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
       CodeBehind="Plantas.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Planta.Plantas" Title="Control de piso - Plantas" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Plantas" ></asp:Label><br/>
                </td> 
            </tr>
                                ...
                                <td>
                                 <table>
                                  <tr>
                                    <td class="textos_01">  
                                        Almacén:
                                        <asp:DropDownList ID="cmbAlmacen" runat="server"  Width="200"  CssClass="textosd" AutoPostBack="true" OnSelectedIndexChanged="cmbProceso_SelectedIndexChanged">
                                        ...
                                        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" EnableAppStyling="False"
                                          OnPageIndexChanged = "cambio_pagina"  > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                     <igtbl:UltraGridColumn Hidden="true" Width="120px" BaseColumnName="ClaveAlmacen" IsBound="True" Key="ClaveAlmacen" CellMultiline="Yes">
                                                            <Header Caption="ClaveAlmacen">
                                                     ...
                                                     <igtbl:UltraGridColumn Width="120px" BaseColumnName="DescripcionAlmacen" IsBound="True" Key="DescripcionAlmacen" CellMultiline="Yes">
                                                            <Header Caption="Almacén">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="ClavePlanta" DataType="System.Int32" IsBound="True" Key="ClavePlanta" Hidden="False">
                                                            <Header Caption="Clave planta"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="DescripcionPlanta" IsBound="True" Key="DescripcionPlanta" CellMultiline="Yes">
                                                          ...
                                                          <igtbl:UltraGridColumn  Hidden="true" Width="150px" BaseColumnName="FechaBaja" IsBound="True" Key="FechaBaja" CellMultiline="Yes">
                                                      ...
                                                      <RowEditTemplate>
                                                        <table style="font-family: Arial; text-align: left" >
                                                            <tr>
                                                                ...
                                                                <td class ="textos_01">
                                                                    <input type="hidden" id="DescripcionAlmacenH" columnkey="DescripcionAlmacen" />
                                                                     <asp:DropDownList ID="CbmPlantaH" runat="server"   CssClass="textosd" AutoPostBack="true"  > </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class ="textos_01">
                                                                ...
                                                                <td class ="textos_01">
                                                                    <input type="hidden" id="ClavePlantaH" columnkey="ClavePlanta" />
                                                                    <input id="ClavePlantaT" columnkey="ClavePlanta" style="width: 150px;" type="text" >
                                                                </td>
                                                            </tr>
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td class ="textos_01">
                                                                    <input type="hidden" id="DescripcionPlantaH" columnkey="DescripcionPlanta" />
                                                                    <input id="DescripcionPlantaT" columnkey="DescripcionPlanta" style="width: 150px;" type="text" >
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <RowTemplateStyle Height="145px" BackColor="White" BorderColor="White" BorderStyle="Ridge"></RowTemplateStyle>
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Plantas" style="width: 200px;" type="text" runat="server"  />  
            ...
            <tr>
                ...
                <td>
                    <igtblexp:UltraWebGridExcelExporter ID="uwgPlantas" WorksheetName="Plantas" DownloadName="Reporte.XLS" runat='server'>
