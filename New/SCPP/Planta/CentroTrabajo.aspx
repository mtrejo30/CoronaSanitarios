<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
    CodeBehind="CentroTrabajo.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Planta.CentroTrabajo" Title="Control de piso - Centros de trabajo" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Centros de trabajo" ></asp:Label><br/>
                </td> 
            </tr>
                               ...
                               <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <igtbl:ultrawebgrid ID="UltraWebGrid1" Width="800px" runat="server" CaptionAlign="Left" 
                                                ...
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                     ...
                                                     <igtbl:UltraGridColumn Width="120px" BaseColumnName="DesProceso" IsBound="True" Key="DesProceso" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="CodCentroTrabajo" DataType="System.Int32" IsBound="True" Key="CodCentroTrabajo" Hidden="False">
                                                            <Header Caption="Clave centro trabajo"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="DesCentroTrabajo" IsBound="True" Key="DesCentroTrabajo" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="LineaProduccion" IsBound="True" Key="id_linea" CellMultiline="Yes">
                                                            <Header Caption="Línea de producción">
                                                        ...
                                                        <igtbl:UltraGridColumn Hidden="true" Width="150px" BaseColumnName="CodPlanta" IsBound="True" Key="CodPlanta" CellMultiline="Yes">
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Centro de trabajo" style="width: 200px;" type="text" runat="server"  />  
