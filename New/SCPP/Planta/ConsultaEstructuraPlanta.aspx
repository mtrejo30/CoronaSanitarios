...
CodeBehind="ConsultaEstructuraPlanta.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Planta.ConsultaEstructuraPlanta" Title="Control de piso - Consulta de estructura de planta"%>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Consulta estructura de planta" ></asp:Label><br/>
                </td> 
            </tr>
            ...
            <tr>
                ...
                </td><td style="width:10px; " rowspan="4">&nbsp;</td>
                <td>           
                                       ...
                                       <!--  <div style="overflow: scroll; width:800px; " > -->
                                        <igtbl:ultrawebgrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" 
                                            ...
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                     <igtbl:UltraGridColumn Width="120px" BaseColumnName="Almacen" IsBound="True" Key="Almacen" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Planta" DataType="System.Int32" IsBound="True" Key="Planta" Hidden="False">
                                                            <Header Caption="Planta"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="LineaProduccion" IsBound="True" Key="LineaProduccion" CellMultiline="Yes">
                                                            <Header Caption="Linea de producción">
                                                                <RowLayoutColumnInfo OriginX="3" />
                                                            </Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                            <Footer><RowLayoutColumnInfo OriginX="3" /></Footer>
                                                        </igtbl:UltraGridColumn>
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="Proceso" IsBound="True" Key="Proceso" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="CentroTrabajo" IsBound="True" Key="CentroTrabajo" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Area" IsBound="True" Key="Area" CellMultiline="Yes">
                                                            <Header Caption="Área">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Maquina" IsBound="True" Key="Maquina" CellMultiline="Yes">
                                                            <Header Caption="Máquina">
                                                                <RowLayoutColumnInfo OriginX="6" />
                                                            </Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                            <Footer><RowLayoutColumnInfo OriginX="6" /></Footer>
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Estructura de planta" style="width: 200px;" type="text" runat="server"  />  
