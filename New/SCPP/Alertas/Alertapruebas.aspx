<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" Title="Control de piso - Alertapruebas" AutoEventWireup="true"
    CodeBehind="Alertapruebas.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Alertas.Alertapruebas" %>
                ...
                <td rowspan="2" valign="top" class="leftarea" style="width:100px">
                    <div id="navcontainer">
                        <ul id="navlist">
                            ...
                            <li><a href="../Alertas/ConfiguracionAlertas.aspx" ID="LAddNew" runat="server"><img src="../Imagenes/Nuevo.png" alt="Nuevo registro" style="border:0px;" /> Nuevo registro</a></li>
