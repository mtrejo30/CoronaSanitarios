<Project DefaultTargets="Build" xmlns="http://schemas.microsoft.com/developer/msbuild/2003" ToolsVersion="3.5">
  ...
  <ItemGroup>
    <WebReferenceUrl Include="http://192.168.24.213/scppservicehh/SCPPHHService.svc">
      <UrlBehavior>Static</UrlBehavior>
      <RelPath>Web References\HHsvc\</RelPath>
      <UpdateFromURL>http://192.168.24.213/scppservicehh/SCPPHHService.svc</UpdateFromURL>
      <ServiceLocationURL>
      </ServiceLocationURL>
    ...
    <WebReferenceUrl Include="http://192.168.24.229/SCPP/Lamosa.SCPP.ServiceManager.ClassImpl.UsuarioServiceManager.svc">
      <UrlBehavior>Dynamic</UrlBehavior>
      <RelPath>Web References\svcUsuario\</RelPath>
      <UpdateFromURL>http://192.168.24.229/SCPP/Lamosa.SCPP.ServiceManager.ClassImpl.UsuarioServiceManager.svc</UpdateFromURL>
      <ServiceLocationURL>
      </ServiceLocationURL>
      <CachedDynamicPropName>
      </CachedDynamicPropName>
  ...
  <ItemGroup>
    ...
    <None Include="Web References\svcUsuario\UsuarioServiceManager.wsdl" />
  </ItemGroup>
