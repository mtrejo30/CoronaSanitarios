...
CodeBehind="AjusteInventario.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Inventarios.AjusteInventario" Title="Control de piso - Ajuste de Inventario"%>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Ajuste de inventario" ></asp:Label><br/>
                </td> 
            </tr>
                                 ...
                                 <tr>
                                    <td class="textos_01">  
                                        Inventario:
                                           ...
                                           <td  class="textos_01"> 
                                    <asp:TextBox ID="Inventario" runat="server" Enabled="False" CssClass="textost" ></asp:TextBox>
                                  </tr>
                                   ...
                                   <tr>
                                    <td class="textos_01">  
                                        Fecha:
                                           ...
                                           <td  class="textos_01"> 
                                    <asp:TextBox ID="Fecha" runat="server" Enabled="False" CssClass="textost" ></asp:TextBox>
                                  </tr>
                                                ...
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                     <igtbl:UltraGridColumn Width="120px" BaseColumnName="Proceso" IsBound="True" Key="Proceso" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Altas" IsBound="True" Key="Altas" CellMultiline="Yes">
                                                            <Header Caption="Altas">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Bajas" IsBound="True" Key="Bajas" CellMultiline="Yes">
                                                            <Header Caption="Bajas">
