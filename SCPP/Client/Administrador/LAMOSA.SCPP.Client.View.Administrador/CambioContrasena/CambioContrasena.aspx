<%@ Page Language="C#" 
    MasterPageFile="~/MasterOut.Master" 	
    AutoEventWireup="true" 
    CodeBehind="CambioContrasena.aspx.cs"  
    Inherits="LAMOSA.SCPP.Client.View.Administrador.CambioContrasena.CambioContrasena"   
    Title="Control de piso - Cambio de contraseña"  %>
...
<script src="../FuncionesJS/htmlTabControl.js" type="text/javascript"></script>
    <div> 
        <asp:ScriptManager ID="sm" runat="server">
            <Scripts> <asp:ScriptReference Path="CallWebServiceMethods.js" /></Scripts>
                                ...
                                <td style=" height:40px" class="textos_01">
                                      <table style="width: 550px">
                                        <tr>
                                            ...
                                            <td class="textos_01">
                                            <asp:TextBox ID="NomUsuario" runat="server" Width="150px" MaxLength="10"  value="" CssClass="textost" ></asp:TextBox></td>
                                         </tr>   
                                        <tr>
                                            <td class="textos_01">
                                               Contraseña anterior:
                                            </td>
                                            <td class="textos_01"><asp:TextBox ID="ContrasenaAnt" runat="server" Width="150px" MaxLength="10"  TextMode="Password"  value="" ></asp:TextBox></td>
                                         </tr>   
                                        <tr>
                                                <td class="textos_01">
                                               Contraseña nueva:
                                                </td>
                                                <td class="textos_01"><asp:TextBox ID="ContrasenaNueva"  runat="server" Width="150px" MaxLength="10" ValidationGroup="grpUs" TextMode="Password" value="" ></asp:TextBox> <!--ValidationGroup="grpUs"-->
                                                </td>
                                           </tr>
                                        <tr>
                                                <td class="textos_01">
                                                ...
                                                <td class="textos_01"><asp:TextBox ID="ConfirmarContra" runat="server" MaxLength="10"  Width=" 150px" value="" TextMode="Password" ValidationGroup="grpUs"></asp:TextBox>
                                                    <asp:CompareValidator ID="cvValidarContrasenias" runat="server" ControlToCompare="ConfirmarContra" ControlToValidate="ContrasenaNueva" ErrorMessage="Las contraseñas no coinciden" Width="210px" ValidationGroup="grpUs"></asp:CompareValidator>
                                                </td>
                                          </tr>
                                        <tr>
                                                  <td class="textos_01"  colspan="2"> 
                                                    <input id="GuardarI" onclick="ok()" class="Boton_01" style="width: 75px;" type="button" value="Guardar"   runat="server" />     
                        ...
                        function ok() {
                            ...
                            if (Usuario != "" && ContrasenaAnt != "" && ContrasenaNueva != "" && ConfirmarContra != "") 
                            {
                                if (confirm('¿Desea guardar cambios?')) 
                                {
                                    ...
                                    var ctrl = document.getElementById("ctl00_Principal_Guardar");
                                    ctrl.click();
                                }
                            }
