<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
    CodeBehind="Empleados.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Administracion.Empleados" Title="Control de piso - Empleados" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Empleados" ></asp:Label><br/>
                </td> 
            </tr>
                                ...
                                <td>
                                   <table>
                                    <tr>
                                     ...
                                     <td>
                                        <asp:DropDownList ID="cmbPlanta2" runat="server" CssClass="textosd" AutoPostBack="true" OnSelectedIndexChanged="cmbPlanta_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="cmbPuesto" runat="server"  CssClass=textosd AutoPostBack="true"
                                                OnSelectedIndexChanged="cmbPuesto_SelectedIndexChanged" ></asp:DropDownList> 
                                        </td>
                                    </tr>
                                   </table>
                                </td>
                                      ...
                                      <td>
                                        <script src="../FuncionesJS/jquery-1.4.2.js" type="text/javascript"></script>
                                                ...
                                                <igtbl:ultrawebgrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" 
                                                      EnableAppStyling="False" OnPageIndexChanged = "cambio_pagina"  Width="800px"  > 
                                                    <Bands>
                                                        <igtbl:UltraGridBand>
                                                            <Columns>
                                                                 <igtbl:UltraGridColumn Width="100px" BaseColumnName="ClaveMFG" IsBound="true" Key="ClaveMFG" CellMultiline="No">
                                                                <Header Caption="Clave MFG">
                                                                ...
                                                                <RowLayoutColumnInfo OriginX="1" />
                                                                  ...
                                                                  <igtbl:UltraGridColumn Width="100px" BaseColumnName="ClaveNomina" IsBound="true" Key="ClaveNomina" CellMultiline="No">
                                                                    <Header Caption="Clave nómina">
                                                                    ...
                                                                    <igtbl:UltraGridColumn Width="80px" BaseColumnName="Nombre" IsBound="true" Key="Nombre" CellMultiline="No">
                                                                ...
                                                                <igtbl:UltraGridColumn Width="120px" BaseColumnName="ApellidoPaterno"  IsBound="true" Key="ApellidoPaterno" CellMultiline="No">
                                                                    <Header Caption="Apellido paterno">
                                                                 ...
                                                                 <igtbl:UltraGridColumn Width="120px" BaseColumnName="ApellidoMaterno"  IsBound="true" Key="ApellidoMaterno" CellMultiline="No">
                                                                   ...
                                                                   <igtbl:UltraGridColumn Width="90px" BaseColumnName="Puesto" IsBound="True" Key="Puesto"  CellMultiline="Yes">
                                                                    <Header Caption="Puesto">
                                                                 ...
                                                                 <igtbl:UltraGridColumn Width="120px" BaseColumnName="CentroDeTrabajo" IsBound="True" Key="CentroDeTrabajo"  CellMultiline="Yes">
                                                                 ...
                                                                 <igtbl:UltraGridColumn Width="120px" BaseColumnName="FechaRegistro" IsBound="True" Key="FechaRegistro"  CellMultiline="Yes">
                                                                  ...
                                                                  <igtbl:UltraGridColumn Width="120px" BaseColumnName="DesPlanta" IsBound="True" Key="DesPlanta"  CellMultiline="Yes">
                                                                    <Header Caption="DesPlanta">
                                                    ...
                                                    <DisplayLayout Name="UltraWebGrid1" AllowDeleteDefault="Yes" 
                                                        ...
                                                        HeaderClickActionDefault="SortSingle" RowSelectorsDefault="No" RowSizingDefault="Free" ScrollBar="Always" ScrollBarView="Horizontal">
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Empleados" style="width: 200px;" type="text" runat="server"  />  
            ...
            <tr>
                ...
                <td >
                    <igtblexp:UltraWebGridExcelExporter ID="uwgEmpleados" WorksheetName="Calidad" DownloadName="Reporte.XLS" runat='server'>
