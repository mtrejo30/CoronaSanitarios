...
{
    public partial class Colores : ReporteBase
    {
        ...
        protected void llenargrid()
        {
            ...
            List<Common.SolutionEntityFramework.BaseSolutionEntity> Lista = svc.ObtenerColores();
            ...
            else
            {
                ...
                UltraWebGrid1.Columns[1].Header.Caption = "Clave color";
        ...
        protected void llenarvacio()
        {
            UltraWebGrid1.ResetColumns();
            UltraWebGrid1.DataBind();
            UltraWebGrid1.Columns.Add("Clave color");
            UltraWebGrid1.Columns.Add("Descripción");
            UltraWebGrid1.Columns.Add("Activo");
          

            UltraWebGrid1.Columns[0].Header.Caption = "Clave color";
        ...
        protected void btnExporta_Click(object sender, EventArgs e)
        {
            ...
            string[] colnames = LAMOSA.SCPP.Server.BusinessEntity.Color.GetPropertyNamesArray();
            foreach (string colname in colnames)
            {
                dsReportXLS.Tables[0].Columns.Add(colname);
            }
            List<Common.SolutionEntityFramework.BaseSolutionEntity> datos = svc.ObtenerColores();
            foreach (Common.SolutionEntityFramework.BaseSolutionEntity item in datos)
            {
                dsReportXLS.Tables[0].Rows.Add(((LAMOSA.SCPP.Server.BusinessEntity.Color)item).ToObjectArray());
            }
