<%@ Page Language="C#" MasterPageFile="~/ControlPisoLamosa.Master" AutoEventWireup="true" 
    CodeBehind="Colores.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Administracion.Colores" Title="Control de piso - Colores" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "6"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Colores" ></asp:Label><br/>
                </td> 
            </tr>
                                    ...
                                    <td>
                                        ...
                                        OnPageIndexChanged = "cambio_pagina" > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                        <igtbl:UltraGridColumn Hidden="true" Width="120px" BaseColumnName="CodColor"  IsBound="True" Key="CodColor" CellMultiline="Yes">
                                                            <Header Caption="CodColor"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="ClaveColor" IsBound="True" Key="ClaveColor" CellMultiline="Yes">
                                                            <Header Caption="Clave color">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="DesColor" IsBound="True" Key="DesColor" CellMultiline="Yes">
                                    ...
                                    <div style="padding: 5px;">
                                        <table cellpadding="0" cellspacing="0" align="center" style="text-align: center;
                                            ...
                                            <tr>
                                                  ...
                                                  <td  class ="textos_01">  
                                                  <input id="nombre" value="Colores" style="width: 200px;" type="text" runat="server"  />  
            ...
            <tr>
                ...
                <td >
                    <igtblexp:UltraWebGridExcelExporter ID="ExpColores" WorksheetName="Colores" DownloadName="ReporteColores.XLS" runat='server'>
