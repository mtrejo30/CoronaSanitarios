...
CodeBehind="Eventos.aspx.cs" Inherits="LAMOSA.SCPP.Client.View.Administrador.Planta.Eventos"  Title="Control de piso - Catálogo de eventos" %>
        ...
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="1024px" >
            ...
            <tr style="height:30px;">
                ...
                <td  colspan= "3"  class ="lblTitulo1">
                    <asp:Label ID="lblTitulo" runat="server"  Text="Eventos" ></asp:Label><br/>
                </td> 
            </tr>
                                    ...
                                    <td>
                                        ...
                                        <igtbl:UltraWebGrid ID="UltraWebGrid1" runat="server" CaptionAlign="Left" EnableAppStyling="False" > 
                                            <Bands>
                                                <igtbl:UltraGridBand>
                                                    <Columns>
                                                     <igtbl:UltraGridColumn Width="120px" BaseColumnName="Clave" IsBound="True" Key="Clave" CellMultiline="Yes">
                                                        ...
                                                        <igtbl:UltraGridColumn Width="120px" BaseColumnName="Descripción" DataType="System.Int32" IsBound="True" Key="Descripción" Hidden="False">
                                                            <Header Caption="Descripción"></Header>
                                                            <HeaderStyle  HorizontalAlign = "Center"></HeaderStyle>
                                                        </igtbl:UltraGridColumn>
                                                        <igtbl:UltraGridColumn Width="150px" BaseColumnName="Correo" IsBound="True" Key="Correo" CellMultiline="Yes">
                                                            <Header Caption="Correo Responsable">
                                                        ...
                                                        <table style="font-family: Arial; text-align: left" >
                                                            <tr>
                                                                ...
                                                                <td class ="textos_01">
                                                                    ...
                                                                    <input id="descripcion" columnkey="descripcion" style="width: 170px;" type="text"  >
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class ="textos_01">
                                                                ...
                                                                <td class ="textos_01">
                                                                    <input type="hidden" id="ocorreo" columnkey="correo" />
                                                                    <input id="correo"columnkey="correo" style="width: 170px;" type="text" >
                                                                </td>
                                                            </tr>
                                                     ...
                                                     <RowTemplateStyle Height="163px"  Width="260px" BackColor="White" BorderColor="White" BorderStyle="Ridge"></RowTemplateStyle>
